---
title: "google real data"
subtitle: "Anthony working away"
---
  
```{r}
#google realtime data
# devtools::install_github("ipeaGIT/gtfs2gps", lib = "C:/Program Files/R/R-3.6.2/library")
library(gtfs2gps)
```

# `gtfs2gps`

Converting GTFS data to GPS-like format. Rafael H. M. Pereira, Pedro R. Andrade, Joao Bazzo
