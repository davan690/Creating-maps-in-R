...
<html lang="en">
  ...
  <title>Transforming Coordinate Reference Systems</title>
  ...
  <meta property="og:title" content="Transforming Coordinate Reference Systems" />
  

   
  <meta property="og:description" content="```{r setup, include=FALSE} knitr::opts_chunk$set(echo = TRUE) ``` The first stage when doing GIS in R is to identify and load the necessary packages: ```{r} library(sp) # foundational package defining sp classes library(tmap) # cutting edge GIS functionality library(geojsonio) # for saving as geojson ``` Next we need some data: ```{r}...">
  ...
  <meta property="og:url" content="http://localhost:4000/R/vignettes/Forked-extra-current/vignettes/download-transform-data.Rmd" />
  <link rel="canonical" href="http://localhost:4000/R/vignettes/Forked-extra-current/vignettes/download-transform-data.Rmd" />
  ...
  <meta name="twitter:title" content="Transforming Coordinate Reference Systems" />
  

  
  <meta name="twitter:description" content="```{r setup, include=FALSE} knitr::opts_chunk$set(echo = TRUE) ``` The first stage when doing GIS in R is to identify and load the necessary packages: ```{r} library(sp) # foundational package defining sp classes library(tmap) # cutting edge GIS functionality library(geojsonio) # for saving as geojson ``` Next we need some data: ```{r}...">
    ...
    <div class="row">
      <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
        <div class="page-heading">
          <h1>Transforming Coordinate Reference Systems</h1>
