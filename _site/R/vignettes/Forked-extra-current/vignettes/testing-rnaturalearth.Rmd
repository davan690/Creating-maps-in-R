...
<html lang="en">
  ...
  <title>Testing rnaturalearth</title>
  ...
  <meta property="og:title" content="Testing rnaturalearth" />
  

   
  <meta property="og:description" content="```{r setup, include=FALSE} knitr::opts_chunk$set(echo = TRUE) ``` [rnaturalearth](https://github.com/AndySouth/rnaturalearth) is an R package for accessing a sample of the world's geographic data. It allows quick access to the data stored at [naturalearthdata.com](http://www.naturalearthdata.com/). It's not yet on CRAN, so you need to install the devtools package to install it easily from github,...">
  ...
  <meta property="og:url" content="http://localhost:4000/R/vignettes/Forked-extra-current/vignettes/testing-rnaturalearth.Rmd" />
  <link rel="canonical" href="http://localhost:4000/R/vignettes/Forked-extra-current/vignettes/testing-rnaturalearth.Rmd" />
  ...
  <meta name="twitter:title" content="Testing rnaturalearth" />
  

  
  <meta name="twitter:description" content="```{r setup, include=FALSE} knitr::opts_chunk$set(echo = TRUE) ``` [rnaturalearth](https://github.com/AndySouth/rnaturalearth) is an R package for accessing a sample of the world's geographic data. It allows quick access to the data stored at [naturalearthdata.com](http://www.naturalearthdata.com/). It's not yet on CRAN, so you need to install the devtools package to install it easily from github,...">
