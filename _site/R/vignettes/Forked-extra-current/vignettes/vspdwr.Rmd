...
<html lang="en">
  ...
  <title>{"formatted"=>"Visualising Spatial Data with R, from base to \\pkg{tmap}", "plain"=>"Visualising Spatial Data with R, from base to tmap", "short"=>"Visualising Spatial Data with R"}</title>
  ...
  <meta property="og:title" content="{"formatted"=>"Visualising Spatial Data with R, from base to \\pkg{tmap}", "plain"=>"Visualising Spatial Data with R, from base to tmap", "short"=>"Visualising Spatial Data with R"}" />
  

   
  <meta property="og:description" content="# Introduction Maps have a long history, closely bound-up with scientific progress, imperial expansion and humanity's sense of place on the Earth [e.g. @roller_eratosthenes_2010;@livingston_geographical_1992]. Computer aided maps can be seen as an extension of the story of cartography, the art and science of map making, into the digital age. Although...">
  ...
  <meta property="og:url" content="http://localhost:4000/R/vignettes/Forked-extra-current/vignettes/vspdwr.Rmd" />
  <link rel="canonical" href="http://localhost:4000/R/vignettes/Forked-extra-current/vignettes/vspdwr.Rmd" />
  ...
  <meta name="twitter:title" content="{"formatted"=>"Visualising Spatial Data with R, from base to \\pkg{tmap}", "plain"=>"Visualising Spatial Data with R, from base to tmap", "short"=>"Visualising Spatial Data with R"}" />
  

  
  <meta name="twitter:description" content="# Introduction Maps have a long history, closely bound-up with scientific progress, imperial expansion and humanity's sense of place on the Earth [e.g. @roller_eratosthenes_2010;@livingston_geographical_1992]. Computer aided maps can be seen as an extension of the story of cartography, the art and science of map making, into the digital age. Although...">
    ...
    <div class="row">
      <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
        <div class="page-heading">
          <h1>{"formatted"=>"Visualising Spatial Data with R, from base to \\pkg{tmap}", "plain"=>"Visualising Spatial Data with R, from base to tmap", "short"=>"Visualising Spatial Data with R"}</h1>
