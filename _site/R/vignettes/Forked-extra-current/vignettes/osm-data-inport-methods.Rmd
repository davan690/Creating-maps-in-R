...
<html lang="en">
  ...
  <meta property="og:description" content="```{r, eval=FALSE} devtools::install_github(&quot;osmdatar/osmdata&quot;) ``` ```{r} bbox ;);out;') dat &lt;- httr::GET (query, timeout=60) doc_txt &lt;- httr::content (dat, &quot;text&quot;, encoding='UTF-8') doc_xml &lt;- xml2::read_xml (httr::content (dat, as=&quot;text&quot;, encoding=&quot;UTF-8&quot;)) write (doc_txt, file=&quot;doc_txt.osm&quot;) microbenchmark::microbenchmark( dat &lt;- osmdatar:::rcpp_get_lines (doc_txt), times=10) library(sf) microbenchmark::microbenchmark( dat &lt;- st_read(dsn = &quot;doc_txt.osm&quot;, layer = &quot;points&quot;), times=10) s = sf::st_read(dsn = &quot;GEOJSON&quot;,...">
  ...
  <meta property="og:url" content="http://localhost:4000/R/vignettes/Forked-extra-current/vignettes/osm-data-inport-methods.Rmd" />
  <link rel="canonical" href="http://localhost:4000/R/vignettes/Forked-extra-current/vignettes/osm-data-inport-methods.Rmd" />
  ...
  <meta name="twitter:description" content="```{r, eval=FALSE} devtools::install_github(&quot;osmdatar/osmdata&quot;) ``` ```{r} bbox ;);out;') dat &lt;- httr::GET (query, timeout=60) doc_txt &lt;- httr::content (dat, &quot;text&quot;, encoding='UTF-8') doc_xml &lt;- xml2::read_xml (httr::content (dat, as=&quot;text&quot;, encoding=&quot;UTF-8&quot;)) write (doc_txt, file=&quot;doc_txt.osm&quot;) microbenchmark::microbenchmark( dat &lt;- osmdatar:::rcpp_get_lines (doc_txt), times=10) library(sf) microbenchmark::microbenchmark( dat &lt;- st_read(dsn = &quot;doc_txt.osm&quot;, layer = &quot;points&quot;), times=10) s = sf::st_read(dsn = &quot;GEOJSON&quot;,...">
