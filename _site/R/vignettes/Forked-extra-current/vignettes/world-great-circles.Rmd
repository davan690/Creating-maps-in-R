...
<html lang="en">
  ...
  <meta property="og:url" content="http://localhost:4000/R/vignettes/Forked-extra-current/vignettes/world-great-circles.Rmd" />
  <link rel="canonical" href="http://localhost:4000/R/vignettes/Forked-extra-current/vignettes/world-great-circles.Rmd" />
  ...
  <meta name="twitter:description" content="Great circles lines on a world map with **rworldmap** and **ggplot2** ======================================================== Sometimes you will want to plot maps on a much larger scale that we have covered previously in the 'Introduction to visualising spatial data in R' [tutorial](https://github.com/Robinlovelace/Creating-maps-in-R/raw/master/intro-spatial-rl.pdf), hosted on the [Creating-maps-in-R github repository](https://github.com/Robinlovelace/Creating-maps-in-R/). For this there are a...">
