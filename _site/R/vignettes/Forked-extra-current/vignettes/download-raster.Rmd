...
<html lang="en">
  ...
  <title>Aerial photos in R</title>
  ...
  <meta property="og:title" content="Aerial photos in R" />
  

   
  <meta property="og:description" content="```{r} library(ggmap) library(raster) gc &lt;- as.numeric(geocode(&quot;Norton Canon&quot;)) ggmap(get_map(location = gc)) gm &lt;- get_map(location = gc, zoom = 20) ggmap(gm) gm &lt;- get_map(&quot;Norton Canon&quot;, zoom = 17, maptype = &quot;satellite&quot;) ggmap(gm) # ggmap(get_googlemap(&quot;Norton Canon&quot;, zoom = 19, maptype = &quot;satellite&quot;, size = c(640,640), scale = 2)) gr1 &lt;- ggmap_rast(map = gm)...">
  ...
  <meta property="og:url" content="http://localhost:4000/R/vignettes/Forked-extra-current/vignettes/download-raster.Rmd" />
  <link rel="canonical" href="http://localhost:4000/R/vignettes/Forked-extra-current/vignettes/download-raster.Rmd" />
  ...
  <meta name="twitter:title" content="Aerial photos in R" />
  

  
  <meta name="twitter:description" content="```{r} library(ggmap) library(raster) gc &lt;- as.numeric(geocode(&quot;Norton Canon&quot;)) ggmap(get_map(location = gc)) gm &lt;- get_map(location = gc, zoom = 20) ggmap(gm) gm &lt;- get_map(&quot;Norton Canon&quot;, zoom = 17, maptype = &quot;satellite&quot;) ggmap(gm) # ggmap(get_googlemap(&quot;Norton Canon&quot;, zoom = 19, maptype = &quot;satellite&quot;, size = c(640,640), scale = 2)) gr1 &lt;- ggmap_rast(map = gm)...">
