...
<html lang="en">
  ...
  <meta property="og:description" content="Use development versions of osmdata and stplanr packages plus a few others: ```{r, eval=FALSE} devtools::install_github(&quot;ropensci/stplanr&quot;) devtools::install_github(&quot;ropensci/osmdata&quot;) ``` ```{r} library(stplanr) library(osmdata) library(tmap) ``` Ensure you have a valid routing API key (e.g. Graphhoper - apply online). Identify the origins and destinations. For distance-to-border calculations the destination would be the nearest point...">
  ...
  <meta property="og:url" content="http://localhost:4000/R/vignettes/Forked-extra-current/vignettes/distance-calculations-stplanr.Rmd" />
  <link rel="canonical" href="http://localhost:4000/R/vignettes/Forked-extra-current/vignettes/distance-calculations-stplanr.Rmd" />
  ...
  <meta name="twitter:description" content="Use development versions of osmdata and stplanr packages plus a few others: ```{r, eval=FALSE} devtools::install_github(&quot;ropensci/stplanr&quot;) devtools::install_github(&quot;ropensci/osmdata&quot;) ``` ```{r} library(stplanr) library(osmdata) library(tmap) ``` Ensure you have a valid routing API key (e.g. Graphhoper - apply online). Identify the origins and destinations. For distance-to-border calculations the destination would be the nearest point...">
