...
<html lang="en">
  ...
  <title>Geographical data out of R</title>
  ...
  <meta property="og:title" content="Geographical data out of R" />
  

   
  <meta property="og:description" content="## Raster package ```{r} lnd_raster % addTiles() %&gt;% addPolygons(data = afg, popup = afg$NAME_1) ``` &gt; **Challenge:** download data for 2 different countries and 2 different levels. &gt; **Challenge:** Try to merge some data you've found from the internet with this geographical data and plot the result using your prefered...">
  ...
  <meta property="og:url" content="http://localhost:4000/R/vignettes/Forked-extra-current/vignettes/get-data.Rmd" />
  <link rel="canonical" href="http://localhost:4000/R/vignettes/Forked-extra-current/vignettes/get-data.Rmd" />
  ...
  <meta name="twitter:title" content="Geographical data out of R" />
  

  
  <meta name="twitter:description" content="## Raster package ```{r} lnd_raster % addTiles() %&gt;% addPolygons(data = afg, popup = afg$NAME_1) ``` &gt; **Challenge:** download data for 2 different countries and 2 different levels. &gt; **Challenge:** Try to merge some data you've found from the internet with this geographical data and plot the result using your prefered...">
    ...
    <div class="row">
      <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
        <div class="page-heading">
          <h1>Geographical data out of R</h1>
