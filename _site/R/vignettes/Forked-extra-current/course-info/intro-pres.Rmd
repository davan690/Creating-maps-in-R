...
<html lang="en">
  ...
  <meta property="og:description" content="```{r, echo=FALSE} library(grid) library(png) ``` # Introduction ```{r, echo=FALSE} # ## Course structure # # ## Description # # This one day course will get you **up-to-speed** with using R and **RStudio** for daily data processing, analysis and visualisation tasks. # It is **practical**, so you'll 'learn by doing'. #...">
  ...
  <meta property="og:url" content="http://localhost:4000/R/vignettes/Forked-extra-current/course-info/intro-pres.Rmd" />
  <link rel="canonical" href="http://localhost:4000/R/vignettes/Forked-extra-current/course-info/intro-pres.Rmd" />
  ...
  <meta name="twitter:title" content="Introduction to R and RStudio" />
  

  
  <meta name="twitter:description" content="```{r, echo=FALSE} library(grid) library(png) ``` # Introduction ```{r, echo=FALSE} # ## Course structure # # ## Description # # This one day course will get you **up-to-speed** with using R and **RStudio** for daily data processing, analysis and visualisation tasks. # It is **practical**, so you'll 'learn by doing'. #...">
