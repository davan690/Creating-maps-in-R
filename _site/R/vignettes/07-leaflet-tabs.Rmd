...
<html lang="en">
  ...
  <meta property="og:description" content="```{r libraries-info} library(leaflet) library(leaflet.extras) ``` ```{r nat2_map, echo = FALSE, message=FALSE, warning=FALSE, comment=NA, out.width='100%'} library(leaflet) library(leaflet.extras) library(htmlwidgets) library(dplyr) make_map % addProviderTiles(&quot;OpenStreetMap.BlackAndWhite&quot;) %&gt;% setView(lng = 30.2189853, lat = 7.1751893, zoom = 7) %&gt;% setMaxBounds( lng1 = 22.625227, lat1 = 1.422041, lng2 = 36.978083, lat2 = 13.528717 ) %&gt;% # addResetMapButton() %&gt;%...">
  ...
  <meta property="og:url" content="http://localhost:4000/R/vignettes/07-leaflet-tabs.Rmd" />
  <link rel="canonical" href="http://localhost:4000/R/vignettes/07-leaflet-tabs.Rmd" />
  ...
  <meta name="twitter:description" content="```{r libraries-info} library(leaflet) library(leaflet.extras) ``` ```{r nat2_map, echo = FALSE, message=FALSE, warning=FALSE, comment=NA, out.width='100%'} library(leaflet) library(leaflet.extras) library(htmlwidgets) library(dplyr) make_map % addProviderTiles(&quot;OpenStreetMap.BlackAndWhite&quot;) %&gt;% setView(lng = 30.2189853, lat = 7.1751893, zoom = 7) %&gt;% setMaxBounds( lng1 = 22.625227, lat1 = 1.422041, lng2 = 36.978083, lat2 = 13.528717 ) %&gt;% # addResetMapButton() %&gt;%...">
