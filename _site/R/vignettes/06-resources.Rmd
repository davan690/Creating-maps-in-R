...
<html lang="en">
  ...
  <meta property="og:description" content="```{r libraries-info1} library(leaflet) library(leaflet.extras) ``` # Resources {#resources} ## A single location on a map Here is the birthplace of R plotted with `leaflet`, `addTiles` and the `addMarkers`... ```{r, echo = FALSE} # my_data % addTiles() %&gt;% # Add default OpenStreetMap map tiles addMarkers(lng=174.768, lat=-36.852, popup=&quot;The birthplace of R&quot;) #...">
  ...
  <meta property="og:url" content="http://localhost:4000/R/vignettes/06-resources.Rmd" />
  <link rel="canonical" href="http://localhost:4000/R/vignettes/06-resources.Rmd" />
  ...
  <meta name="twitter:description" content="```{r libraries-info1} library(leaflet) library(leaflet.extras) ``` # Resources {#resources} ## A single location on a map Here is the birthplace of R plotted with `leaflet`, `addTiles` and the `addMarkers`... ```{r, echo = FALSE} # my_data % addTiles() %&gt;% # Add default OpenStreetMap map tiles addMarkers(lng=174.768, lat=-36.852, popup=&quot;The birthplace of R&quot;) #...">
...
gpkg_df = readr::read_csv("data/generic_map_pkgs.csv")
