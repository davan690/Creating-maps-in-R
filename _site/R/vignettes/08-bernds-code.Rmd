...
<html lang="en">
  ...
  <meta property="og:title" content="Bernds-code" />
  

   
  <meta property="og:description" content="```{r setup, include=FALSE} knitr::opts_chunk$set(echo = TRUE) ``` ```{r} #recombined data set after zooming (&quot;fishes_clean.csv&quot;&quot;) usedbf =FALSE if (!usedbf) fishes . When you click the **Knit** button a document will be generated that includes both content as well as the output of any embedded R code chunks within the document. You...">
  ...
  <meta property="og:url" content="http://localhost:4000/R/vignettes/08-bernds-code.Rmd" />
  <link rel="canonical" href="http://localhost:4000/R/vignettes/08-bernds-code.Rmd" />
  ...
  <meta name="twitter:title" content="Bernds-code" />
  

  
  <meta name="twitter:description" content="```{r setup, include=FALSE} knitr::opts_chunk$set(echo = TRUE) ``` ```{r} #recombined data set after zooming (&quot;fishes_clean.csv&quot;&quot;) usedbf =FALSE if (!usedbf) fishes . When you click the **Knit** button a document will be generated that includes both content as well as the output of any embedded R code chunks within the document. You...">
