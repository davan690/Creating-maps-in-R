...
<html lang="en">
  ...
  <title>R: a command-line GIS</title>
  ...
  <meta property="og:title" content="R: a command-line GIS" />
  

   
  <meta property="og:description" content="As spatial datasets get larger and more sophisticated, new software tools are needed to enable analysis, modelling and visualisation. R is a widely used open source platform for statistical analysis with proven capabilities using its base functionality and 6000+ contributed packages. Less well known is that R increasingly popular for...">
  ...
  <meta property="og:url" content="http://localhost:4000/R/vignettes/book-vig/girona-abstract.Rmd" />
  <link rel="canonical" href="http://localhost:4000/R/vignettes/book-vig/girona-abstract.Rmd" />
  ...
  <meta name="twitter:title" content="R: a command-line GIS" />
  

  
  <meta name="twitter:description" content="As spatial datasets get larger and more sophisticated, new software tools are needed to enable analysis, modelling and visualisation. R is a widely used open source platform for statistical analysis with proven capabilities using its base functionality and 6000+ contributed packages. Less well known is that R increasingly popular for...">
